...
<div align="center">
  <img src="screenshots/screenshot.png" alt="PDFツールメイン画面" style="border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" width="80%">
  <p><em>メイン画面：アップロード・変換・結合・分割・透かし追加が直感的に操作できます</em></p>
</div>
---
...
├── screenshots/               # スクリーンショットフォルダ
│   └── screenshot.png         # UIメイン画面のキャプチャ
